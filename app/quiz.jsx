...
const Quiz = () => {
    ...
    const [selectedAnswer, SetSelectedAnswer] = useState( {A: false, B: false, C: false, D: false} )

    const selectedAnswerA = () => { SetSelectedAnswer ({A: true, B: false, C: false, D: false})}
    const selectedAnswerB = () => { SetSelectedAnswer ({A: false, B: true, C: false, D: false})}
    const selectedAnswerC = () => { SetSelectedAnswer ({A: false, B: false, C: true, D: false})}
    const selectedAnswerD = () => { SetSelectedAnswer ({A: false, B: false, C: false, D: true})}
    ...
    if (showResult){
        return(
            <QuizResults score={score} len={Data.length}/>
        )
    }
